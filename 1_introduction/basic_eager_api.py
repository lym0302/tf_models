...
liangym 20190214 https://github.com/aymericdamien/TensorFlow-Examples/blob/master/examples/1_Introduction/basic_eager_api.py
...
# Fully compatibility with numpy
...
print("a*b = %s" % (a*b)) # element multiple

#d = tf.matmul(a, b)      # matrix multiple but It seems that this tensorflow version does not support
#print("a * b = %s" % d)
